...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* 0: mostly letters */
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_FN4, KC_FN5, KC_P, \
         KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, \
         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, \
         KC_FN0, KC_FN6, KC_DEL, KC_LGUI, KC_FN7, KC_FN8, KC_FN9,     \
  ...
  /* 1: punctuation and numbers */
   KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, SHIFT(KC_LBRC), SHIFT(KC_RBRC), \
          ...
          KC_TRNS, KC_FN1, KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS,    \
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [4] = ACTION_LAYER_TAP_KEY(3, KC_I), // switch to kbd keys layer
  ...
  [8] = ACTION_MODS_TAP_KEY(MOD_RCTL, KC_BSPC), // hold for ctl tap for bspc
